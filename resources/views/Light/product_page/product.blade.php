...
@section('content')
    <div class="container" id="product_page">
        <div class="row justify-content-center">
            <div class=" position-relative overflow-hidden text-white" style=" background: transparent;"
                 data-aos="fade-right">
                <div
                    class="position-absolute gap-2 d-flex align-items-center justify-content-center m-2 p-2 buttons_container">
                    @if(\Illuminate\Support\Facades\Auth::check())
                        ...
                        <button type="button"
                                ...
                                data-id="{{$product->id}}">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" href="20"
                                 fill="silver">
